...
export const ViewMapPage = ({ onNavigate }) => {
  return (
      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900">View Fullscreen Map</h1>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200/80 shadow-md text-center flex flex-col items-center justify-center min-h-[400px]">
          ...
          <p className="text-sm text-slate-500 max-w-md mb-6 leading-relaxed">
            This page is reserved for full-screen GIS satellite feeds, high-density layer configurations, and regional disaster tracking.
          </p>
          <button
            onClick={() => onNavigate('landing')}
